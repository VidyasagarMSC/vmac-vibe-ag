...
export function Hero() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-background border-b border-border/40 pt-20 md:pt-0">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
                <div className="flex flex-col items-center text-center space-y-8">
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-7xl font-bold tracking-tight font-heading text-foreground px-4 md:px-0"
                    >
